...
Процедура ПриЗаписи(Отказ)
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		...
		Сообщить("ВыборкаДетальныеЗаписи.Дата = " + ВыборкаДетальныеЗаписи.Дата);
		Сообщить("ТекущаяДата() = " + ТекущаяДата());
		Сообщить("ВыборкаДетальныеЗаписи.Специалист = " + ВыборкаДетальныеЗаписи.Специалист);
		Сообщить("ВКМ_Специалист = " + ВКМ_Специалист);
